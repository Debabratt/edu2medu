        ...
        >
          <div className="bg-opacity-70 bg-[#1E2939] px-8 py-10 rounded-lg max-w-lg w-full shadow-xl">
            <h1 className="text-3xl sm:text-4xl font-bold text-white">
              Feel Free to Contact <span className="text-[#18a3a8]">Us</span>
            </h1>
            ...
            <button className="mt-6 w-full py-3 bg-[#1e998b] text-white rounded-lg hover:bg-[#67533e] transition duration-300">
              Request Call
            </button>
          </div>
        </div>
