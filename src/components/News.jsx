    ...
    const newsList = [
      {
        ...
        image: "https://source.unsplash.com/900x500/?news,technology",
      },
      {
        id: 2,
        ...
        image: "https://source.unsplash.com/500x300/?business,stock",
      },
      {
        id: 3,
      ...
      <div>
        ...
        <div className="max-w-6xl mx-auto mt-32">
          <div className="relative bg-white rounded-lg shadow-md overflow-hidden mb-12">
            <img src={newsList[0].image} alt="Featured News" className="w-full h-64 object-cover" />
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {newsList.slice(1).map((news) => (
              <div key={news.id} className="bg-white p-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-300">
                <img src={news.image} alt="News" className="w-full h-40 object-cover rounded-lg" />
