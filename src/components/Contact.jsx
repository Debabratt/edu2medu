...
const Contact = () => {
  ...
  return (
    <div
      className="h-full flex items-center justify-center py-12 px-6 sm:px-16 lg:px-32 bg-cover bg-center"
      style={{
        backgroundImage: "url('pattern.png')", // Replace 'pattern.png' with the actual pattern image URL
        backgroundSize: "20px 20px", // Adjust the size of the pattern
        backgroundRepeat: "repeat",
      }}
    >
      <div className="container mx-auto flex flex-col items-center justify-center space-y-8">
        <div
          className="flex flex-col items-center text-center space-y-4 bg-cover bg-center bg-no-repeat"
          style={{
            backgroundImage: "url('cn.jpg')", // Keeps the existing image background
          }}
        >
          <div className="bg-opacity-70 bg-[#1E2939] px-8 py-10 rounded-lg max-w-lg w-full shadow-xl">
            ...
            <p className="text-lg sm:text-xl mt-3 text-[#e69721]">
              Your child’s dream school is just a call away.
            </p>
